---
name: pr-create
description: Invoke ONLY when user runs the `/pr-create` slash command. Do not auto-invoke. Creates a DRAFT GitHub PR with a JIRA-prefixed conventional commit title and a Summary/Details body drafted from the branch's diff.
---
