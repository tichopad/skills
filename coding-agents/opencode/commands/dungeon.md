...
1. A brief DM introduction (2-3 sentences of atmosphere). Example: _"You stand at the entrance of `<project-name>`, a vast structure built with TypeScript and Express. Corridors branch in every direction, each leading to a different domain of logic. Your torch flickers — let's begin."_
